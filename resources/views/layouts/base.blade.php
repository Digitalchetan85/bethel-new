    ...
    <header class="page-header">
            ...
            <div class="container">
                <div class="navbar-header">
                    <div class="mobile-topline">
                        ...
                        <div class="phone-number"><span>+91 98800 37944</span></div>
                    </div>
                    <div class="header-top">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="logo"> <a href="{{route('home')}}"
                                        class="text-white text-decoration-none"><span class="hidden-xs">Bethel
                                            <span class="text-info">Computech</span></span>
                                        <span class="visible-xs">Bethel <span
                                                class="text-info">Computech</span></span>
                                    </a> </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="phone">
                                    <div class="phone-wrapper">
                                        ...
                                        <div class="number"><span>+91 98800 37944</span></div>
                                    </div>
                                    <div class="right-text">
                                        <div class="item arrow animation hoveranimation"
                                            data-animation="rotateInUpRight" data-animation-delay="0.5s"><img
                                                src="{{ asset('assets/images/call-us-arrow-1.png') }}" alt=""></div>
                                        <div class="item text1 animation hoveranimation" data-animation="fadeInUp"
                                            data-animation-delay="0.75s"><img
                                                src="{{ asset('assets/images/call-us-arrow-2.png') }}" alt=""></div>
                                        <div class="item text2 animation hoveranimation" data-animation="fadeInUp"
                                            data-animation-delay="1s"><img
                                                src="{{ asset('assets/images/call-us-arrow-3.png') }}" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="slidemenu" data-hover="dropdown" data-animations="fadeIn" class="bg-info text-white">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="{{ Request::is('about') ? 'active' : '' }}"><a href="{{ route('about') }}"
                                class="">About</a></li>
                        <li class="dropdown {{ Request::is('service') ? 'active' : '' }}"><a href="#"
                                data-toggle="dropdown" data-submenu="" class="">Services<span
                                    class="ecaret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li class="{{ Request::is('service') ? 'active' : '' }}"><a
                                        href="{{ route('services.laptop-repair') }}">Laptop Repair</a></li>
                                <li class="{{ Request::is('service') ? 'active' : '' }}"><a
                                        href="{{ route('services.pc-repair') }}">PC Repair</a></li>
                                <li class="{{ Request::is('service') ? 'active' : '' }}"><a
                                        href="{{ route('services.mac-repair') }}">Mac Repair</a></li>
                                <li class="{{ Request::is('service') ? 'active' : '' }}"><a
                                        href="{{ route('services.data-backup') }}">Data Backup and Recovery</a></li>
                                <li class="{{ Request::is('service') ? 'active' : '' }}"><a
                                        href="{{ route('services.software-installation') }}">Malware and Virus
                                        Removal</a></li>
                                <li class="{{ Request::is('service') ? 'active' : '' }}"><a
                                        href="{{ route('services.hardware-updates') }}">Software Installation</a></li>
                            </ul>
                        </li>
                        <li class="{{ Request::is('laptop') ? 'active' : '' }}"><a href="{{ route('laptop') }}"
                                class="">Laptop</a>
                        </li>
                        ...
                        <li class="{{ Request::is('desktop') ? 'active' : '' }}"><a href="{{ route('desktop') }}"
                                class="">Desktop</a>
                        </li>
                        <li class="{{ Request::is('monitor') ? 'active' : '' }}"><a href="{{ route('monitor') }}"
                                class="">Monitor</a>
                        </li>
                        ...
                        @if (Route::has('login'))
                            @auth
                                ...
                                @endif
                            @else
                                <li class="d-none" style="display: none"><a href="{{ route('register') }}"
                                        class="">Register</a>
                                </li>
                                <li class="d-none" style="display: none"><a href="{{ route('login') }}"
                                        class="">Login</a>
                                </li>
                            @endif
        ...
        <script type="text/javascript">
            ...
            (function() {
                ...
                s1.async = true;
                s1.src = 'https://embed.tawk.to/62664d14b0d10b6f3e6f3109/1g1fpq6g1';
                s1.charset = 'UTF-8';
